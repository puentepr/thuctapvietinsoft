...
namespace HPA.Component
{
	...
	public class UIMessage
	{
        ...
        private static string GetKeyValue(DataRow drOld, string TableName)
        {
            ...
            {
                retVal += drOld[dr[0].ToString()].ToString() + " , ";
            }
		...
		public static System.Windows.Forms.DialogResult ShowMessage(object objMessageID, System.Windows.Forms.MessageBoxButtons mbb, System.Windows.Forms.MessageBoxIcon mbi)
		{
			if ((DBEngine == null) ||
				...
				throw new Exception("Database engine and related information have not initialized yet in UIMessage module");
			...
			{
				System.Windows.Forms.MessageBox.Show(e.Message + "\n\nHPA.Component.UIMessage.ShowMessage()", MessageBoxTitle, System.Windows.Forms.MessageBoxButtons.OK, System.Windows.Forms.MessageBoxIcon.Error);
				return System.Windows.Forms.DialogResult.None;
			}
		}
        ...
        public static void LoadLableName(ref System.Windows.Forms.Control.ControlCollection  ctrs)
        {
            ...
            foreach (System.Windows.Forms.Control ctr in ctrs)
            {
                ...
                if (ctr is DevExpress.XtraEditors.DateEdit && ((DevExpress.XtraEditors.DateEdit)ctr).Properties.Mask.UseMaskAsDisplayFormat == false)
                {
                    ...
                    ((DevExpress.XtraEditors.DateEdit)ctr).LookAndFeel.SkinName = SKIN_BLUE;
                ...
                if (ctr is DevExpress.XtraEditors.LookUpEdit)
                {
                    ...
                    ((DevExpress.XtraEditors.LookUpEdit)ctr).LookAndFeel.SkinName = SKIN_BLUE;
                    continue;
                }
                if (ctr is DevExpress.XtraEditors.SimpleButton)
                {
                    ...
                    ((DevExpress.XtraEditors.SimpleButton)ctr).LookAndFeel.SkinName =  SKIN_BLUE;
                ...
                if (ctr is DevExpress.XtraTreeList.TreeList)
                {
                    ...
                    ((DevExpress.XtraTreeList.TreeList)ctr).LookAndFeel.SkinName = SKIN_BLUE;
                }
                    ...
                    )
                {
                    try
                    {
                        ...
                        if (!ctr.Text.Trim().Equals(string.Empty))
                        {
                            ...
                            if (obj.ToString().Trim().Equals(string.Empty))
                            {
                                ctr.Text = ctr.Name + " " + UIMessage.languageID;
                            }
                            else
        ...
        {
            string strRetval = "";
            System.Data.DataTable dtInfo = DBEngine.execReturnDataTable("sp_GetInformInfor");
